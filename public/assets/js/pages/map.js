document.addEventListener('DOMContentLoaded', function () {
    ...
    function activateRulerMode(startLatLng = null) {
        ...
        // *** LOGIC MỚI: Thêm class vào map container để CSS xử lý ***
    ...
    function deactivateRulerMode() {
        ...
        // *** LOGIC MỚI: Gỡ bỏ class khỏi map container ***
    ...
    function findClosestStationToSnap(mouseLatLng) { /* ... code không đổi ... */ }
    function handleRulerMove(e) { /* ... code không đổi ... */ }
    function handleRulerEnd(e) { /* ... code không đổi ... */ }
    ...
    // Các nút trong popup HTML
    btnRulerFromCurrent.addEventListener('click', () => {
        navigator.geolocation.getCurrentPosition(
            pos => activateRulerMode(L.latLng(pos.coords.latitude, pos.coords.longitude)),
    ...
    // *** ĐÃ KHÔI PHỤC ĐẦY ĐỦ LOGIC CHO 2 NÚT NÀY ***
    // Nút "Vị trí của tôi"
    ...
    // --- HIỂN THỊ CÁC TRẠM VÀ XỬ LÝ DỮ LIỆU ---
    // (Sao chép lại các hàm không thay đổi để đảm bảo đầy đủ)
    findClosestStationToSnap = function(mouseLatLng) {
