...
<body>
    <div class="verification-container">
        ...
        <form action="/public/handlers/action_handler.php?module=auth&action=verify-reset-otp" method="POST">
          ...
          <form id="resendForm" action="/public/handlers/action_handler.php?module=auth&action=resend-reset-otp" method="POST">
            <div class="form-group">
                ...
                <a href="/public/pages/auth/forgot_password.php" class="button secondary-button">Quay lại</a>
            </div>
        </form>
    </div>
    ...
    <script>        // OTP input handling
        ...
        function updateFullOtp() {
          ...
          // Countdown timer        let timeLeft = 15 * 60; // 15 minutes in seconds
